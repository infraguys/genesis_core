...
cli_opts = [
    cfg.StrOpt(
        ...
        default="/opt/genesis_core/etc/90-genesis-net-config.yaml.j2",
    ...
    cfg.StrOpt(
        ...
        default="/opt/genesis_core/etc/genesis_core/genesis_core.conf.j2",
        help="Path to the core config template",
    ),
    cfg.StrOpt(
        "core_config_template_dst",
        default="/etc/genesis_core/genesis_core.conf",
        help="Path to the core config destination file",
    ),
    cfg.StrOpt(
        "ua_config_template_src",
        default=(
            "/opt/genesis_core/etc/genesis_universal_agent/"
    ...
    cfg.StrOpt(
        ...
        default="/opt/genesis_core/etc/systemd/resolved.conf.j2",
    ...
    cfg.StrOpt(
        ...
        default="/opt/genesis_core/etc/dnsdist/dnsdist-private.conf.j2",
