...
class Node(
    ...
    def insert(self, session=None):
        ...
        # Handle a special case for EM. We cannot put volumes in the same project as the node
        # because the volumes are created as children of the node and they aren't present
        # in the manifest. So EM doesn't know about the volumes.
        volume_project_id = (
            self.project_id
