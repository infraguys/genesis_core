...
class IamClient(
    ...
    def get_token_by_password(self, username, **kw):
        """
        ...
        return self._get_token_by_password_and_smth(
            users_query=users_query, **kw
        )

    def get_token_by_password_username(self, **kw):
        """
        Get auth token by username + password.
        This is just an alias for get_token_by_password_username,
        to ensure consistency.
        """
        return self.get_token_by_password(**kw)

    def get_token_by_password_email(self, email, **kw):
        """
    ...
    def get_token_by_password_phone(self, **kw):
        """
    ...
    def get_token_by_password_login(self, login, **kw):
        """
