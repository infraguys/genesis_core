...
from genesis_core.tests.functional import base as test_base
...
def auth_user_admin(
    ...
    return test_base.GenesisCoreAuth(
...
def user_api_client(user_api):
    return lambda auth: test_base.GenesisCoreTestRESTClient(
...
def default_machine_agent(
    user_api_client: test_base.GenesisCoreTestRESTClient,
    auth_user_admin: test_base.GenesisCoreAuth,
...
def default_pool(
    ...
    url = client.build_resource_uri(["hypervisors", uuid])
