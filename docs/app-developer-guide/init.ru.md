...
`genesis init` **платформенизирует** существующий проект — он подготавливает всё, что нужно платформе Genesis Core для сборки, публикации и развёртывания его как элемента.
