...
- [`exordos elements install`](deploy.md) — установка элемента из репозитория в realm
- [`exordos deploy`](deploy.md) — развёртывание локальной сборки в realm за один шаг (сборка + публикация + установка)
