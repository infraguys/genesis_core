...
PERMISSION_UUIDS = {
    ...
    PERMISSION_PROJECT_DELETE_ALL: generate_uuid(PERMISSION_PROJECT_DELETE_ALL),
    ...
    PERMISSION_ROLE_BINDING_CREATE: generate_uuid(PERMISSION_ROLE_BINDING_CREATE),
    PERMISSION_ROLE_BINDING_READ: generate_uuid(PERMISSION_ROLE_BINDING_READ),
    PERMISSION_ROLE_BINDING_UPDATE: generate_uuid(PERMISSION_ROLE_BINDING_UPDATE),
    PERMISSION_ROLE_BINDING_DELETE: generate_uuid(PERMISSION_ROLE_BINDING_DELETE),
    PERMISSION_IAM_CLIENT_CREATE: generate_uuid(PERMISSION_IAM_CLIENT_CREATE),
    PERMISSION_IAM_CLIENT_READ_ALL: generate_uuid(PERMISSION_IAM_CLIENT_READ_ALL),
