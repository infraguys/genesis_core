...
class MigrationStep(migrations.AbstractMigrationStep):
    ...
    def upgrade(self, session):
        expressions = [
            ...
            """
            ALTER TABLE machines 
                ADD COLUMN IF NOT EXISTS block_devices JSONB;
            """,
            """
            ...
            CREATE TABLE IF NOT EXISTS compute_machine_volumes (
                ...
                node_volume UUID references node_volumes(uuid) ON DELETE SET NULL,
            ...
            """
            ALTER TABLE machine_pools 
                ADD IF NOT EXISTS storage_pool_map JSONB DEFAULT '{}';
            """,
            """
            ALTER TABLE machine_pools 
            ...
            """,
            """
            CREATE OR REPLACE VIEW compute_unscheduled_computes AS
                SELECT
    ...
    def downgrade(self, session):
        ...
        expressions = [
            """
            DROP VIEW IF EXISTS compute_unscheduled_computes;
            """,
            """
            DROP VIEW IF EXISTS compute_nodes_without_ports;
            """,
            ...
            """
            ALTER TABLE machine_pools 
                DROP COLUMN IF EXISTS storage_pool_map;
            """,
            """
            ALTER TABLE machine_pools 
            ...
            """
            ALTER TABLE machines 
                ADD IF NOT EXISTS image VARCHAR(255) NOT NULL;
            """,
            """
            ALTER TABLE machines 
